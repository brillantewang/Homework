...
class MetaCorgiSnacks
  ...
  # def method_missing(name, *args)
    # info_meth = "get_#{name.to_s}_info"
    # tastiness_meth = "get_#{name.to_s}_tastiness"
    #
    # info = @snack_box.send(info_meth, @box_id)
    # tastiness = @snack_box.send(tastiness_meth, @box_id)
